...
class AsyncWebServerRequest {
  ...
  private:
    ...
    StringLinkedList<AsyncWebHeader *> _headers;
    StringLinkedList<AsyncWebParameter *> _params;
    StringLinkedList<String *> _pathParams;
...
class AsyncWebServer {
  protected:
    AsyncServer _server;
    StringLinkedList<AsyncWebRewrite*> _rewrites;
    StringLinkedList<AsyncWebHandler*> _handlers;
...
class DefaultHeaders {
  using headers_t = StringLinkedList<AsyncWebHeader *>;
  headers_t _headers;
