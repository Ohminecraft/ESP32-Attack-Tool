...
: _messageQueue(StringLinkedList<AsyncEventSourceMessage *>([](AsyncEventSourceMessage *m){ delete  m; }))
{
...
AsyncEventSource::AsyncEventSource(const String& url)
  : _url(url)
  , _clients(StringLinkedList<AsyncEventSourceClient *>([](AsyncEventSourceClient *c){ delete c; }))
  , _connectcb(NULL)
  , _connectcb2(NULL)
  , _disconnectcb(NULL)
{}
